...
<html>
    ...
    <body class="easyui-layout" style="font-family: Calibri;">
        <div data-options="region: 'north',border: false" style="height: 55%; padding: 10px;background-color: #1F2C35;overflow: hidden">
            <form class="easyui-form" id="frmChem" action="PurGlass">
                <input type="hidden" name="email" value="<%= email%>"/>
                <input type="hidden" name="producttp" value="glassware"/>
                <table width="100%" border="0" cellpadding="5" cellspacing="5" style="font-size: 12pt;-webkit-filter: drop-shadow(5px 5px 5px #222); filter: drop-shadow(5px 5px 5px #222);background-image: url('images/glass.png');background-size: 200px 200px;background-position: 10% 50%; background-repeat: no-repeat; background-position-y: center">
                    ...
                    <tr>
                        <td width="40%" align="right">Glassware:</td>
                        <td>
                            <select name="productid" class="easyui-combobox" style="width: 320px;">
                                ...
                                %>
                                <option value="<%= c.getProductId()%>"><%= c.getProductId()+ " - " + c.getDescGoods()+ " - " + c.getMake()+ " - " + c.getPrice()%></option>
                                <%
                                    }
                                %>
                            </select>
