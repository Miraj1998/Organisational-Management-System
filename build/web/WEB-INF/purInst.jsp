<%-- 
    Document   : purInst
    Created on : 19 Feb, 2019, 11:43:40 AM
    Author     : Vivek
--%>
...
<html>
    ...
    <body class="easyui-layout" style="font-family: Calibri;">
        <div data-options="region: 'north',border: false" style="height: 55%; padding: 10px;background-color: #1F2C35;overflow: hidden">
            <form class="easyui-form" id="frmChem" action="PurInst">
                <input type="hidden" name="email" value="<%= email%>"/>
                <input type="hidden" name="producttp" value="instrument"/>
                <table width="100%" border="0" cellpadding="5" cellspacing="5" style="font-size: 12pt;-webkit-filter: drop-shadow(5px 5px 5px #222); filter: drop-shadow(5px 5px 5px #222);background-image: url('images/instrument.png');background-size: 200px 200px;background-position: 10% 50%; background-repeat: no-repeat; background-position-y: center">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="productid" class="easyui-combobox" style="width: 320px;">
                                ...
                                %>
                                <option value="<%= c.getInstrumentsId()%>"><%= c.getInstrumentsId()+ " - " + c.getDescGoods()+ " - " + c.getCatNo()+ " - " + c.getRate()%></option>
                                <%
                                    }
                                %>
                            </select>
